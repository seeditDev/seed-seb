...
const TRANSITIONS = {
  ...
  [ATTEMPT_STATES.STARTING]:           [ATTEMPT_STATES.STARTED, ATTEMPT_STATES.IN_PROGRESS, ATTEMPT_STATES.FAILED_FATAL],
  [ATTEMPT_STATES.STARTED]:            [ATTEMPT_STATES.IN_PROGRESS, ATTEMPT_STATES.SUBMITTING, ATTEMPT_STATES.EXPIRED, ATTEMPT_STATES.FAILED_RECOVERABLE, ATTEMPT_STATES.FAILED_FATAL],
  [ATTEMPT_STATES.IN_PROGRESS]:        [ATTEMPT_STATES.SUBMITTING, ATTEMPT_STATES.EXPIRED, ATTEMPT_STATES.FAILED_RECOVERABLE, ATTEMPT_STATES.FAILED_FATAL],
  [ATTEMPT_STATES.SUBMITTING]:         [ATTEMPT_STATES.SUBMITTED,  ATTEMPT_STATES.AUTO_SUBMITTED, ATTEMPT_STATES.FAILED_RECOVERABLE, ATTEMPT_STATES.FAILED_FATAL],
  [ATTEMPT_STATES.EXPIRED]:            [ATTEMPT_STATES.SUBMITTING, ATTEMPT_STATES.AUTO_SUBMITTED, ATTEMPT_STATES.FAILED_RECOVERABLE],
  [ATTEMPT_STATES.FAILED_RECOVERABLE]: [ATTEMPT_STATES.SUBMITTING, ATTEMPT_STATES.IN_PROGRESS, ATTEMPT_STATES.AUTO_SUBMITTED],
};
 ...
 * Format: {assessmentId}_{uid}
 *
 * Canonical format matches the proctoring service convention so all
 * subsystems (session service, proctoring logs, result creation, Firestore
 * rules exists() bindings) use exactly one ID shape.
 *
 ...
 * @returns {string}  Format: {assessmentId}_{uid}
