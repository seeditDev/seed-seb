...
export const Route = createFileRoute("/student/mcq/$testSlug")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Attempt your timed, proctored multiple-choice test in the SEED-SEB secure exam portal." },
      { property: "og:title", content: "MCQ test — SEED-SEB" },
      { property: "og:description", content: "Attempt your timed, proctored multiple-choice test in the SEED-SEB secure exam portal." },
