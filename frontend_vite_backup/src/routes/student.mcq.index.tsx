...
export const Route = createFileRoute("/student/mcq/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Timed multiple-choice assessments with proctoring inside the SEED-SEB secure exam portal." },
      { property: "og:title", content: "MCQ assessments — SEED-SEB" },
      { property: "og:description", content: "Timed multiple-choice assessments with proctoring inside the SEED-SEB secure exam portal." },
