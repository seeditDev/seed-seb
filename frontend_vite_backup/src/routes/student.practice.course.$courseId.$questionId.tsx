...
export const Route = createFileRoute("/student/practice/course/$courseId/$questionId")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Work through course-linked coding exercises in the SEED-SEB practice sandbox." },
      { property: "og:title", content: "Course practice — SEED-SEB" },
      { property: "og:description", content: "Work through course-linked coding exercises in the SEED-SEB practice sandbox." },
