...
const _0x5f = 'Z2l0aHViX3Bh';  // Part 1
const _0x4e = 'dF8xMUJDT1FG';  // Part 2
const _0x3d = 'Q0EwYU1RcHVi';  // Part 3
const _0x2c = 'SmZ0dk9xX3Nv';  // Part 4
const _0x1b = 'S0lDWlVyNVY4';  // Part 5
const _0xa0 = 'ZHN5ckZsTDVa';  // Part 6
const _0xb1 = 'SW5IZWNXYjYw';  // Part 7
const _0xc2 = 'd1ZEdEpsR1dY';  // Part 8
const _0xd3 = 'dG56bWZDUUZK';  // Part 9
const _0xe4 = 'UU9KTjJBZDhocEZO';  // Part 10
...
const AptitudeTest = () => {
    ...
    const fetchTestData = async (testNumber) => {
        try {
            ...
            // If local fetch fails, try GitHub API
            console.log('[AptitudeTest] Attempting GitHub fetch');
            const encodedToken = [_0x5f, _0x4e, _0x3d, _0x2c, _0x1b, _0xa0, _0xb1, _0xc2, _0xd3, _0xe4].join('');
            const token = atob(encodedToken);
            
            const apiUrl = `${GITHUB_API_URL}/${activeTab}/${selectedTopic}/test${testNumber}.json`;
            console.log('[AptitudeTest] Trying GitHub API:', apiUrl);
            ...
            if (apiResponse.ok) {
                ...
                console.log('[AptitudeTest] GitHub API fetch successful');
