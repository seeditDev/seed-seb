...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SEED-SEB — Secure Exam Browser Portal" },
      {
        name: "description",
        content:
          "SEED-SEB is the secure, proctored assessment portal for MCQ, coding and spoken-English tests.",
      },
      { name: "author", content: "SEED-IT" },
      { property: "og:title", content: "SEED-SEB — Secure Exam Browser Portal" },
      {
        property: "og:description",
        content: "Proctored MCQ, coding and spoken-English assessments for students.",
      },
