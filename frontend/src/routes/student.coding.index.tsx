...
export const Route = createFileRoute("/student/coding/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Browse and launch proctored coding assessments in the SEED-SEB secure exam portal." },
      { property: "og:title", content: "Coding assessments — SEED-SEB" },
      { property: "og:description", content: "Browse and launch proctored coding assessments in the SEED-SEB secure exam portal." },
