...
export const Route = createFileRoute("/student/practice/solve/$questionId")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Practice a coding problem with live test cases in the SEED-SEB sandbox." },
      { property: "og:title", content: "Practice problem — SEED-SEB" },
      { property: "og:description", content: "Practice a coding problem with live test cases in the SEED-SEB sandbox." },
