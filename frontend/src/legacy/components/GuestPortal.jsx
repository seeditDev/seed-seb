...
const GuestPortal = () => {
  ...
  useEffect(() => {
    ...
    setChecking(true);
    setAttempted(false);
    checkAlreadyAttempted(selectedTest.testId, guestId)
  ...
  const launchAssessment = useCallback(() => {
    ...
    if (type === 'mcq') {
      navigate(`/student/mcq/${selectedTest.testId}`, { state: { guestSession, testDoc: selectedTest } });
    } else if (type === 'coding') {
      navigate(`/student/coding/${selectedTest.testId}`, { state: { guestSession, testDoc: selectedTest } });
